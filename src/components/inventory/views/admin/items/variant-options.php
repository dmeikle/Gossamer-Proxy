<div class="widget" ng-controller="variantOptionsListCtrl">
    <div class="widgetheader">
        ...
        <div class="toolbar form-inline">
            ...
            <form ng-submit="search(basicSearch.query)" class="input-group">
                <input class="form-control" type="text" ng-model="basicSearch.query.option"
    ...
    <table class="table table-striped table-hover">
        <thead>
            <tr>
                ...
                <th column-sortable data-column="option">
                    <?php echo $this->getString('INVENTORY_VARIANT_OPTION') ?>
                </th>
                <th column-sortable data-column="code">
                    <?php echo $this->getString('INVENTORY_VARIANT_CODE') ?>
                </th>
                <th column-sortable data-column="surcharge">
        ...
        <tbody>
            ...
            <tr ng-if="!loading" ng-repeat="item in variantList">
                <td ng-click="selectRow(item)">{{item.locale}}</td>
                <td ng-click="selectRow(item)">{{item.option}}</td>
                <td ng-click="selectRow(item)">{{item.code}}</td>
                <td ng-click="selectRow(item)">{{item.surcharge | currency}}</td>
