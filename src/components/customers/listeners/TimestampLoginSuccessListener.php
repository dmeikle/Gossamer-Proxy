...
class TimestampLoginSuccessListener extends AbstractListener {
    ...
    public function on_login_success(Event &$event) {
        ...
        $params = array('Customers_id' => $params['client']->getId(), 'ipAddress' => $params['client']->getIpAddress());

        $datasource = $this->getDatasource('components\customers\models\AccessLogModel');
