...
class CustomerInviteModel extends  AbstractModel implements FormBuilderInterface
{
    ...
    public function save($id) {
        ...
        $params[$this->entity]['InviterCustomers_id'] = $this->getLoggedInStaffId();
    ...
    public function edit($id) {
        ...
        $params = array('id' => intval($id), 'InviterCustomers_id' => $this->getLoggedInStaffId());
