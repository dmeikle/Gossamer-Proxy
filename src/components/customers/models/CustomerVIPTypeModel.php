...
class CustomerVIPTypeModel extends AbstractModel implements FormBuilderInterface {
    ...
    public function save($id) {
        ...
        return $this->dataSource->query(self::METHOD_POST, $this, 'saveCustomer', $params[$this->entity]);
    }
