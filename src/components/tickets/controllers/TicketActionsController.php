...
use components\tickets\forms\TicketResolutionBuilder;
 ...
 * @author Dave Meikle
 */
class TicketResolutionsController extends AbstractController {
    ...
    public function listall($offset = 0, $limit = 20) {
        ...
        $this->render(array('TicketResolutions' => $result['TicketResolutions'], 'TicketResolutionsCount' => $result['TicketResolutionsCount'], 'form' => $this->drawForm($this->model)));
    }
    ...
    public function drawForm(FormBuilderInterface $model, array $values = null) {
        ...
        $builder = new TicketResolutionBuilder();
