 ...
 * @author Dave Meikle
 */
class TicketActionBuilder extends AbstractBuilder {
    ...
    public function buildForm(FormBuilder $builder, array $values = null, array $options = null, array $validationResults = null) {
        ...
        $builder->add('action', 'text', array('class' => 'form-control', 'value' => $this->buildLocaleValuesArray('action', $values, $options['locales'])), $options['locales'])
                ->add('history', 'text', array('class' => 'form-control', 'value' => $this->buildLocaleValuesArray('history', $values, $options['locales'])), $options['locales'])
