 ...
 * @author Dave Meikle
 */
class TicketStatusBuilder extends AbstractBuilder{
    ...
    public function buildForm(FormBuilder $builder, array $values = null, array $options = null, array $validationResults = null) {
        ...
        $builder->add('status', 'text', array('class' => 'form-control', 'value' => $this->buildLocaleValuesArray('status', $values, $options['locales'])), $options['locales'])
                ->add('statusId', 'hidden', array('class' => 'form-control', 'value' => $id))
