 ...
 * @author Dave Meikle
 */
class TicketCategoryBuilder extends AbstractBuilder {
    ...
    public function buildForm(FormBuilder $builder, array $values = null, array $options = null, array $validationResults = null) {
        ...
        $builder->add('category', 'text', array('class' => 'form-control', 'value' => $this->buildLocaleValuesArray('category', $values, $options['locales'])), $options['locales'])
                ->add('prefix', 'text', array('class' => 'form-control', 'value' => $this->getValue('prefix', $values)))
