 ...
 * @author Dave Meikle
 */
class TicketTypeBuilder extends AbstractBuilder{
    ...
    public function buildForm(FormBuilder $builder, array $values = null, array $options = null, array $validationResults = null) {
        ...
        $builder->add('type', 'text', array('class' => 'form-control', 'value' => $this->buildLocaleValuesArray('status', $values, $options['locales'])), $options['locales'])
                ->add('priority', 'select', array('class' => 'form-control', 'options' => $this->getPriorities()))
    ...
    private function getPriorities() {
        return '<option value="1">Low</option><option value="2">Medium</option><option value="3">High</option><option value="4">Blocker</option>';
    }
