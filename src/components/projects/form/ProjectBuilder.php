...
class ProjectBuilder extends AbstractBuilder{
    ...
    public function buildForm(FormBuilder $builder, array $values = null, array $options = null, array $validationResults = null) {
        ...
        $builder->add('buildingName', 'text', array('ng-model' => 'project.buildingName', 'class' => 'form-control','required' => "", 'value' => $this->getValue('buildingName', $values)))
                ->add('address1', 'text', array('ng-model' => 'project.address1', 'class' => 'form-control','required' => "", 'value' => $this->getValue('address1', $values)))
                ...
                ->add('city', 'text', array('ng-model' => 'project.city', 'class' => 'form-control','required' => "", 'value' => $this->getValue('city', $values)))
                ->add('postalCode', 'text', array('ng-model' => 'project.postalCode', 'class' => 'form-control','required' => "", 'value' => $this->getValue('postalCode', $values)))
                ->add('Provinces_id', 'select', array('ng-model' => 'project.Provinces_id', 'class' => 'form-control','required' => "", 'options' => $options['provinces']))
                ...
                ->add('buildingYear', 'text', array('ng-model' => 'project.buildingYear', 'class' => 'form-control','required' => "", 'value' => $this->getValue('buildingYear', $values)))
                ...
                ->add('strataNumber', 'text', array('ng-model' => 'project.strataNumber', 'class' => 'form-control','required' => "", 'value' => $this->getValue('strataNumber', $values)))
