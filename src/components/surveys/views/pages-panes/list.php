<script language="javascript">
    ...
    $(document).ready(function () {
        ...
        function addRowId(row) {
            $('<input>').attr('type', 'hidden').attr('name', 'paneId[]').attr('value', row.id).appendTo('#form1');
        }
        ...
        $("#search").autocomplete({
            ...
            source: function (request, response) {
                ...
                $.post("/admin/surveys/panes/search", request, function (data, status, xhr) {
        ...
        $("#sortable").sortable({
            ...
            stop: function (event, ui) {
                ...
                $.ajax({
                    data: data,
                    type: 'POST',
                    url: '/admin/surveys/pages/panes/saveorder/' + url[5]
                });
                setLIColors();
            },
            ...
            <td>
                ...
                <ul id="sortable" class="connectedSortable">
                    ...
                    foreach ($SurveyPagePanes as $pagepane) {
                        ...
                        ?>
                        <li id="SurveyPanes_id-<?php echo $pagepane['id']; ?>" class="ui-state-default"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span><?php echo $pagepane['name']; ?></li>
