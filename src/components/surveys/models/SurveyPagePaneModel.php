 ...
 * @author Dave Meikle
 */
class SurveyPagePaneModel extends AbstractModel implements FormBuilderInterface {
    ...
    public function __construct(HTTPRequest $httpRequest, HTTPResponse $httpResponse, Logger $logger) {
        ...
        $this->entity = 'SurveyPagePane';
        $this->tablename = 'surveypagepanes';
    }
