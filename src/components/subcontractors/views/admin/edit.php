...
<div class="cards">
    <div class="leftcard">
        <form role="form" class="form-standard" method="post" id="subcontractor-form" ng-controller="subcontractorsEditCtrl">
            <?php echo $form['id']; ?>
            <table class="table">
                <tr>
...
<div class="cards">
    ...
    <table class="table table-over table-striped" ng-controller="subcontractorsClaimsListCtrl">
        <thead>
            <tr>
