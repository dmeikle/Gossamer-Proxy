...
<p>there should only be selections to acknowledge this page and the invitee should be ported into contacts table and 
    removed from the invitees table once we see if there are duplicates with the same email address or not. <br>
perhaps a "yes that is me" - we need to make sure an invitee's email does not already exist in the contacts table - 
