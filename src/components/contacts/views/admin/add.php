    ...
    <table class="table">
        ...
        <tr>
            <td colspan="2">
                ...
                <tr>
                  <td>Username:</td>
                  <td><input class="form-control" placeholder="Username" name="Contact[username]" type="text" /></td>
                </tr>
                <tr>
                  <td>Password:</td>
                  <td><input class="form-control" placeholder="Password" name="Contact[password]" type="password" /></td>
                </tr>
                <tr>
                  <td>Confirm:</td>
                  <td><input class="form-control" placeholder="Confirm Password" name="Contact[passwordConfirm]" type="password" /></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                         <button class="btn btn-primary">Add and Return</button> <button class="cancel btn btn-primary">Cancel</button>
                    </td>
                </tr>
              </table>
