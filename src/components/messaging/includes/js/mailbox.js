...
$(document).ready(function(){
	...
	function circloidMailboxInbox(){
		...
		$(".email-delete").on("click", function(e){
			...
			var messageDelete = '<div class="alert alert-success alert-dismissable" style="opacity:0;"><button aria-hidden="true" data-dismiss="alert" class="close" type="button">Ã—</button><strong>Deleted!</strong> Email(s) deleted.</div>';
		...
		$(".email-mark-junk").on("click", function(e){
			...
			var messageDelete = '<div class="alert alert-success alert-dismissable" style="opacity:0;"><button aria-hidden="true" data-dismiss="alert" class="close" type="button">Ã—</button><strong>Moved!</strong> Email(s) have been moved to the Junk Folder.</div>';
	...
	function circloidMessageCompose(){
		...
		$("#send-email").on("click", function(){
			...
			if(emailsMainObj == ""){
				...
				var successMessage = '<div class="alert alert-success alert-dismissable text-left" style="display:none;"><button aria-hidden="true" data-dismiss="alert" class="close" type="button">Ã—</button><strong>MESSAGE SENT (DEMO ONLY)</strong><br /><br />' + emailsMainText + emailsCcText + emailsBccText + '</div>';
