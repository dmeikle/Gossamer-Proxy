...
function HasCaption(obj)
{
    ...
    if (pbShowCaption == true)
    {
        ...
        if (pbCaption == null && elem.title != "")
            pbCaption = elem.title;
    }
...
function CreateRevertBar(obj)
{
    ...
    pbShowImage = (pbShowImage != null) ? (pbShowImage == "true" || pbShowImage == true) : popBoxShowRevertImage;
    if (pbText == null)
        pbText = popBoxRevertText;
    if (pbImage == null)
        pbImage = popBoxRevertImage;
...
function CreatePopBar(obj)
{
    if (typeof obj == "string")
        obj = GetRawObject(obj);
    if (typeof pbPopBarFunc[obj.id] != 'undefined' && pbPopBarFunc[obj.id] != null)
        return;
    ...
    if (pbShowBar != null)
    {
        ...
        if (pbText == null)
            pbText = popBoxPopText;
        if (pbImage == null)
            pbImage = popBoxPopImage;
...
{
    if (pbShowBar == false && pbShowText == false && pbShowImage == false && pbCaption == null)
        return;
    if (typeof obj == "string")
        obj = GetRawObject(obj);
    ...
    else
    {
        ...
        if (typeof obj.style.styleFloat != "undefined")
            objSpan.style.styleFloat = floatValue;
        else if (typeof obj.style.cssFloat != "undefined")
            objSpan.style.cssFloat = floatValue;
...
{
    if (typeof divCapTrans == "string")
        divCapTrans = GetRawObject(divCapTrans);
    if (typeof divCapText == "string")
        divCapText = GetRawObject(divCapText);
...
function PopEx(obj, newLeft, newTop, newWidth, newHeight, speed, className)
{
    ...
    if (hasRevertBar == true && popBoxRevertBarAbove == true)
        windowSize.y -= 20;
    if (hasCaption == true && popBoxCaptionBelow == true)
        windowSize.y -= 20;
...
function Revert(obj, speed, className)
{
    if (typeof obj == "string")
        obj = GetRawObject(obj);
    if (obj == null || typeof popBox[obj.id] == "undefined" || popBox[obj.id] == null)
        return;
