<div class="cardtable" ng-controller="companyClientsListCtrl">
    <div ng-repeat="client in clientsList" class="sidePanelRow">
        ...
        <div class="deductable"><?php echo $this->getString('COMPANIES_DEDUCTABLE_AMOUNT') ?> {{ client.deductable}}</div>
        <div class="reason"><?php echo $this->getString('COMPANIES_REASON') ?> <br />{{ client.reason}}</div>
