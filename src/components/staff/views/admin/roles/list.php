...
@components/staff/includes/js/admin-roles-list.js

<!--- javascript end --->
<h3>Staff Role Types</h3>
...
<div id="dialog-form" title="Create new key type" style="display:none">
    ...
    <form id="form1">
        <input type="hidden" id="Role_id" name="StaffRole[id]" value="0">
        <table class="table" id="form1">
            <tr>
                ...
                <td>
                    <input class="form-control" type="text" name="StaffRole[title]" id='Role_title' />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input class="form-control" type="text" name="StaffRole[role]" id='Role_role' />
                </td>
            </tr>
        </table>
    </form>
