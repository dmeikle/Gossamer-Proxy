...
class StaffBuilder extends AbstractBuilder {
    ...
    public function buildForm(FormBuilder $builder, array $values = null, array $options = null, array $validationResults = null) {
        ...
        $builder->add('firstname', 'text', array('ng-model' => 'ctrl.staff.firstname', 'class' => 'form-control', 'value' => $this->getValue('firstname', $values)))
                ...
                ->add('employeeNumber', 'div', array('ng-model' => 'ctrl.staff.employeeNumber', 'class' => 'form-control', 'value' => $this->getValue('employeeNumber', $values)))
                ...
                ->add('extension', 'text', array('ng-model' => 'ctrl.staff.extension', 'class' => 'form-control col-xs-5', 'value' => $this->getValue('extension', $values)))
