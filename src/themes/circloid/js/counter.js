    ...
    if (window.sc_project && (_sc_project_int == 9560334 || _sc_project_int == 6709687 || _sc_project_int == 9879613 || _sc_project_int == 4124138 || _sc_project_int == 204609 || 9993602 < _sc_project_int &&
        ...
        try {
            ...
            function detectBrowserFeatures() {
                ...
                var i;
                var mimeType;
                var pluginMap = {pdf: "application/pdf", qt: "video/quicktime", realp: "audio/x-pn-realaudio-plugin", wma: "application/x-mplayer2", dir: "application/x-director", fla: "application/x-shockwave-flash", java: "application/x-java-vm", gears: "application/x-googlegears",
                ...
                if (!(new RegExp("MSIE")).test(navigator.userAgent)) {
                    ...
                    if (typeof navigator.javaEnabled !== "unknown" && typeof navigator.javaEnabled !== "undefined" &&
            ...
            function generate_uuid() {
                ...
                var seed = (navigator.userAgent || "") + (navigator.platform || "") + detectBrowserFeatures() +
                ...
                for (var i = 0; i < guid_len; i++)
                    if (include_dashes && (i == 8 || i == 13 || i == 18 || i == 23))
                        ...
                        guid[i] = "4";
                    else if (i == 13 && !include_dashes || i == 15 && include_dashes)
                        guid[i] = "F";
                    else {
                        if (rnd <= 2)
            ...
            sc_debug_img.src = "http://statcounter.com/feedback/?email=javascript@statcounter.com&page_url=" + encodeURIComponent(document.location.protocol + "//" + document.location.host + document.location.pathname + document.location.search + document.location.hash) + "&name=Auto%20JS&feedback_username=statcounter&pid=" +
    ...
    function _sc_validateTags(tags) {
        ...
        if (!(tags.length % 2 == 0))
            ...
            if (tags.length / 2 > max_tag_count)
                errors.push("No more than " +
                        max_tag_count + " tags can be passed - " + tags.length / 2 + " passed.");
    ...
    function sc_write_data() {
        if (sc_inv == 1 || sc_prerendering == 2) {
            ...
            if (window.sc_call)
                ...
                sc_call = 1;
            try {
                if (readCookie("sc_pending_" + sc_project))
                    ...
                    for (var ts in pending)
                        (function (ts_scoped) {
                            ...
                            _sc_imgs[sc_call + "." + ts_scoped].onload = function () {
                                ...
                                if (pending_str == "{}")
                                    removeCookie("sc_pending_" +
                                            sc_project, window.location.host);
                                else
                                    createCookie("sc_pending_" + sc_project, pending_str, window.location.host)
                            };
                            if (ts_scoped != now)
                                t_url += "&pg=" + Math.round((now - ts_scoped) / 1E3);
            ...
            document.writeln('<span class="statcounter">' + sc_link_back_start + '<img src="' + sc_base_dir + "&sc_random=" + Math.random() + sc_tracking_url + "&p=" + sc_prerendering + '" alt="' + sc_alt_text + '" border="0"' + sc_counter_size + ">" +
                    sc_link_back_end + "</span>")
    }}
)([], 256, 6, 52);
if (sc_cls > 0)
    if (clickstat_done != 1) {
            ...
            if (adata) {
                ...
                if (clickmode != 0) {
                    ...
                    if (sc_link.length > 0) {
                        ...
                        var sc_req = sc_click_dir + "click.gif?sc_project=" + clickstat_project + "&security=" +
                                clickstat_security + "&c=" + sc_link + "&m=" + clickmode + "&u=" + sc_url + "&t=" + sc_title + "&rand=" + Math.random() + "&u1=" + sc_uuid.substring(1) + sc_unique_returning;
        ...
        function sc_exitpage(e) {
            ...
            for (var i = 0; i < ad.length; i++) {
                ...
                var adH =
                        parseInt(adTop, 10) + parseInt(ad[i].height, 10) + 10;
