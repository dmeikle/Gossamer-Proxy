...
use core\exceptions\EventListenerNotFoundException;
...
class EventHandler {
    ...
    public function notifyListeners() {
        ...
        // echo $this->state . ' ' . $listener['event']."\r\n";
            ...
            if ($this->state == $listener['event'] && is_callable($handler)) {
                ...
                if(!class_exists($listenerClass)) {
                    throw new EventListenerNotFoundException('Unable to load ' . $listenerClass . ' from event dispatcher configuration');
                }
