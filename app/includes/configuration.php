...
//V1 fix - no apikey is being passed, but it's russia only using this deprecated API - ok to hard code their key here
$_SERVER['QUERY_STRING'] .= ((strpos($_SERVER['QUERY_STRING'], '?') !== false) ?  '&' : '?' ) . 'apikey=ea17ba1c-97b3-11e4-8cb1-d2dc20RUSSIA';
