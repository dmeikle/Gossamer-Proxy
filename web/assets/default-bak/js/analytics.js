(function () {
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/, pc = function (a) {
            ...
            b:{
                ...
                if (d && !(1 > d[y])) {
                    ...
                    for (var e = 0; e < d[y]; e++) {
                        ...
                        g = d[e][A](".");
                        var ca = g.shift();
                        ("GA1" == ca || "1" == ca) && 1 < g[y] ? (ca = g.shift()[A]("-"), 1 == ca[y] && (ca[1] = "1"), ca[0] *= 1, ca[1] *= 1, g = {H: ca, s: g[H](".")}) : g = void 0;
                        g && c[p](g)
                    }
                    if (1 == c[y]) {
                        J(13);
        ...
        if (d && a.get(cc) && (b = M[B][h])) {
            ...
            d = [];
            for (c = 0; c < b[y]; ++c)
                (D(b[c], "utm_id") || D(b[c], "utm_campaign") || D(b[c], "utm_source") || D(b[c], "utm_medium") || D(b[c],
