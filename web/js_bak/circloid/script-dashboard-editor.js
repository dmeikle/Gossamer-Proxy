	...
	*/
	...
	function saveCircloidSettings() {
		...
		$.ajax({
			...
			error: function(){
				...
				$('<div class="alert alert-danger hidden"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + textAjaxError + '</div>').prependTo(".dashboard-editor-content").css("visibility", "visible").fadeIn(300);
			...
			success: function(json) {
				...
				if(json.success_saved_settings){
					$('<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + json.success_saved_settings + '</div>').prependTo(".dashboard-editor-content").css("visibility", "visible").fadeIn(300, function(){
						setTimeout(function(){
					...
					$('<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + json.error_saved_settings + '</div>').prependTo(".dashboard-editor-content").css("visibility", "visible").fadeIn(300, function(){
						setTimeout(function(){
							$(".success").fadeOut(300, function(){
								$(this).remove();
							});
			...
			success: function(json) {
				...
				*/
				...
				if(json.success_profile_enabled){
					$('<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + json.success_profile_enabled + '</div>').prependTo(".dashboard-editor-content").css("visibility", "visible").fadeIn(300, function(){

						$("body").removeClass().addClass(json.profile_enabled['css_name']);

						$(".dashboard-editor-color-profile table.table tbody tr .disabled").removeClass('hidden').css("visibility", "visible").fadeIn(300);
						$(".dashboard-editor-color-profile table.table tbody tr .enabled").hide();
						$(".dashboard-editor-color-profile table.table tbody tr .action span").removeClass('hidden').css("visibility", "visible").fadeIn(300);

						$(clickedLink).parents().eq(1).prev().find(".disabled").hide();
						$(clickedLink).parents().eq(1).prev().find(".enabled").removeClass('hidden').css("visibility", "visible").fadeIn(300);
				...
				if(json.error_profile_enabled){
					$('<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + json.error_profile_enabled + '</div>').prependTo(".dashboard-editor-content").css("visibility", "visible").fadeIn(300);
				}
			}
		});
	}
		...
		$.ajax({
			...
			success: function(json) {
				...
				if(json.success_widget_layout){
					$('<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + json.success_widget_layout + '</div>').prependTo(".dashboard-editor-content").css("visibility", "visible").fadeIn(300);

					$(".dashboard-editor-widget-editor table.table tbody tr .disabled").removeClass('hidden').css("visibility", "visible").fadeIn(300);
					$(".dashboard-editor-widget-editor table.table tbody tr .enabled").hide();
					$(".dashboard-editor-widget-editor table.table tbody tr .action span").removeClass('hidden').css("visibility", "visible").fadeIn(300);
				...
				if(json.error_widget_layout){
					$('<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + json.error_widget_layout + '</div>').prependTo(".dashboard-editor-content").css("visibility", "visible").fadeIn(300);
				}
			}
		});
	}
	...
	function copyWidgetLayout(id, new_layout_name, new_description, clickedLink) {
		...
		$.ajax({
			...
			error: function(){
				var textAjaxError = $(".ajax-error").text();
				$('<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + textAjaxError + '</div>').prependTo(".dashboard-editor-content .modal-header").css("visibility", "visible").fadeIn(300);
			...
			success: function(json) {
				...
				if(json.success_layout_copied){
					$('<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + json.success_layout_copied + '</div>').prependTo(".dashboard-editor-content .modal-header").css("visibility", "visible").fadeIn(300);
				...
				if(json.error_layout_copied){
					$('<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + json.error_layout_copied + '</div>').insertAfter(".dashboard-editor-content .modal-header").css("visibility", "visible").fadeIn(300);
				}
			}
		});
}
	...
	function deleteWidgetLayout(id, clickedLink) {
		...
		$.ajax({
			...
			error: function(){
				var textAjaxError = $(".ajax-error").text();
				$('<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + textAjaxError + '</div>').prependTo(".dashboard-editor-content").css("visibility", "visible").fadeIn(300);
				$(".dashboard-editor-widget-editor .loading").hide();
			},
			success: function(json) {
				...
				if(json.success_widget_layout_deleted){
					$('<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + json.success_widget_layout_deleted + '</div>').prependTo(".dashboard-editor-content").css("visibility", "visible").fadeIn(300);
				...
				if(json.error_widget_layout_deleted){
					$('<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + json.error_widget_layout_deleted + '</div>').prependTo(".dashboard-editor-content").css("visibility", "visible").fadeIn(300);
				}
			}
		});
}
	...
	// Map
	var colorMap1 = $("#map-color-1").val();
	$("#map-color-1").spectrum({
		color: colorMap1,
		showSelectionPalette: true,
		showInput: true,
		clickoutFiresChange: true
	...
	var colorMap2 = $("#map-color-2").val();
	$("#map-color-2").spectrum({
		color: colorMap2,
		showSelectionPalette: true,
		showInput: true,
		clickoutFiresChange: true
	...
	// Quick Blocks
	var colorQuickBlock1 = $("#quick_blocks-color-1").val();
	$("#quick_blocks-color-1").spectrum({
		color: colorQuickBlock1,
		showSelectionPalette: true,
		showInput: true,
		clickoutFiresChange: true
	});

	var colorQuickBlock2 = $("#quick_blocks-color-2").val();
	$("#quick_blocks-color-2").spectrum({
		color: colorQuickBlock2,
		showSelectionPalette: true,
		showInput: true,
		clickoutFiresChange: true
	});

	var colorQuickBlock3 = $("#quick_blocks-color-3").val();
	$("#quick_blocks-color-3").spectrum({
		color: colorQuickBlock3,
		showSelectionPalette: true,
		showInput: true,
		clickoutFiresChange: true
	});

	var colorQuickBlock4 = $("#quick_blocks-color-4").val();
	$("#quick_blocks-color-4").spectrum({
		color: colorQuickBlock4,
		showSelectionPalette: true,
		showInput: true,
		clickoutFiresChange: true
	});
	...
	$(".save-layout").click(function(e){
		...
		$.ajax({
			...
			error: function(){
				var textAjaxError = $(".ajax-error").text();
				$('<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + textAjaxError + '</div>').prependTo("#layout-editor-outer").css("visibility", "visible").fadeIn(300);
				$(".loading").hide();
			},
			success: function(json) {
				...
				if(json.success_layout_updated){
					$('<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + json.success_layout_updated + '</div>').prependTo("#layout-editor-outer").css("visibility", "visible").fadeIn(300, function(){
				...
				if(json.error_layout_updated){
					$('<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + json.error_layout_updated + '</div>').prependTo("#layout-editor-outer").css("visibility");
